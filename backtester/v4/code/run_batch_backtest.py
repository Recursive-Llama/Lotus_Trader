#!/usr/bin/env python3
"""
Batch backtest runner V4 - runs backtest workflow for multiple tokens sequentially.
"""
...
# File is at: backtester/v4/code/run_batch_backtest.py
...
def main():
    ...
    print(f"\n{'='*60}")
    print(f"Batch Backtest V4: {len(tickers)} token(s), {days} days each")
