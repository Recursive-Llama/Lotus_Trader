...
from intelligence.system_control.central_intelligence_layer.central_intelligence_agent import CentralIntelligenceAgent
...
# Database imports
from database.alpha_detector_database import AlphaDetectorDatabase
from database.models.alpha_detector_models import ADStrand
...
class CILFunctionalityTester:
    ...
    async def setup(self):
        ...
        try:
            ...
            self.cil_agent = CentralIntelligenceAgent()
            await self.cil_agent.initialize()
        ...
        for pattern in patterns:
            try:
                strand = ADStrand(
                    ...
                    team_member=pattern['team_member'],
                    kind=pattern['kind'],
                ...
                await self.db.insert_strand(strand)
                inserted_ids.append(str(strand.id))
    ...
    async def test_strategic_intelligence_generation(self):
        ...
        try:
            ...
            global_synthesis = GlobalSynthesisEngine()
            ...
            experiment_engine = ExperimentOrchestrationEngine()
    ...
    async def test_cross_agent_communication(self):
        ...
        try:
            ...
            output_system = OutputDirectiveSystem()
    ...
    async def test_decision_making(self):
        ...
        try:
            ...
            engines = [
                ('GlobalSynthesis', GlobalSynthesisEngine()),
                ('InputProcessor', InputProcessor()),
                ('ExperimentOrchestration', ExperimentOrchestrationEngine()),
                ('LearningFeedback', LearningFeedbackEngine()),
                ('AutonomyAdaptation', AutonomyAdaptationEngine()),
                ('OutputDirective', OutputDirectiveSystem()),
                ('Governance', GovernanceSystem()),
                ('SystemResonance', SystemResonanceManager())
            ]
