...
async def analyze_batch_4():
    supabase = SupabaseManager()
    
    print('=== BATCH 4 ANALYSIS - META, neet, USELESS, ZC, BETLY ===')
    print()
    
    # Positions to analyze
    positions = ['META', 'neet', 'USELESS', 'ZC', 'BETLY']
    ...
    for ticker in positions:
        ...
        if result.data:
            ...
            original_quantities = {
                'META': 0.00401639076511581,
                'neet': 564.746857957906,
                'USELESS': 55.9872948132184,
                'ZC': 31899.541436882,
                'BETLY': 50493.3470099517
            }
